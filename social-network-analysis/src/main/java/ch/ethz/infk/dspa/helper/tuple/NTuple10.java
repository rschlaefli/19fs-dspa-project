 ...
 */
public class NTuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> extends Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> {
	...
	public NTuple10(String name0, T0 value0, String name1, T1 value1, String name2, T2 value2, String name3, T3 value3,
			String name4, T4 value4, String name5, T5 value5, String name6, T6 value6, String name7, T7 value7,
			String name8, T8 value8, String name9, T9 value9) {
		...
		this.nameMap.put(name9, 9);
	}

	public static <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> NTuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> of(
			String name0,
			T0 value0,
			String name1, T1 value1, String name2, T2 value2, String name3, T3 value3, String name4, T4 value4,
			String name5,
			T5 value5, String name6, T6 value6, String name7, T7 value7, String name8, T8 value8, String name9,
			T9 value9) {
		return new NTuple10<>(name0, value0, name1, value1, name2, value2, name3, value3, name4, value4, name5, value5,
