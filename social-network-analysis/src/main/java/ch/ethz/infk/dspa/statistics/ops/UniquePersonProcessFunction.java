...
public class UniquePersonProcessFunction extends KeyedProcessFunction<Long, PostActivity, Tuple3<Long, Long, Integer>> {
    ...
    @Override
    public void processElement(PostActivity value, Context ctx, Collector<Tuple3<Long, Long, Integer>> out) throws Exception {
    ...
    @Override
    public void onTimer(long timestamp, OnTimerContext ctx, Collector<Tuple3<Long, Long, Integer>> out) throws Exception {
